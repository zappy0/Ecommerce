<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:pranali.raghatwan@spit.ac.com"><i class="fas fa-envelope"></i> pranali.raghatwan@spit.ac.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>SE</span> | all rights reserved!</div>
